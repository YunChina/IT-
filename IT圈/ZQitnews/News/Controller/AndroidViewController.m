...
@interface AndroidViewController ()
    ...
    [[AFNetworkReachabilityManager sharedManager] setReachabilityStatusChangeBlock:^(AFNetworkReachabilityStatus status)
     {
         switch (status)
         {
             ...
             case AFNetworkReachabilityStatusReachableViaWWAN:{
                 [NewsRequestData getDataWithUrlStr:kAndroid success:^(NSArray *array) {
                     [self.array addObjectsFromArray:array];
...
-(void)shufflingFigureAction{
    [NewsRequestData getPicDataWithUrlStr:kAndroidpic success:^(NSArray *picArr, NSArray *titleArr) {
